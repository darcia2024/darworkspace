...
export function isDuplicateProjectName(projects: ProjectCard[], name: string, excludeId?: string): boolean;
export function duplicateProjectNames(projects: ProjectCard[]): string[];
