...
export const INITIAL_STATE: DaruWorkOSState = {
  ...
  financialReport: {
    ...
    accounts: [
      { name: 'Mandiri', balance: 6855812, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'bank' },
      { name: 'Bank Jago', balance: 37257, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'bank' },
      { name: 'blu by BCA', balance: 17733, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'bank' },
      { name: 'LINE Bank', balance: 1359836, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'bank' },
      { name: 'DANA', balance: 27496, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'ewallet' },
      { name: 'GoPay', balance: 8390, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'ewallet' },
      { name: 'Cash', balance: 0, isLatest: true, lastUpdated: '6 Sep 2026 (Live)', type: 'cash' },
    ],
    trajectory: [
      ...
      { date: '2 Sep', balance: 9892741, note: 'Peak Pemasukan September (Surplus +Rp5,89M)' },
      { date: '6 Sep (Live)', balance: 8306524, note: 'Mandiri Rp6,85M • LINE Rp1,35M • Total Kas Rp8,30M (Surplus +Rp4,30M di atas Floor!)' },
    ],
    recoveryRoadmap: {
    ...
    runwayMonths: 1.8,
    monthlyExpenses: [
      { id: 'exp-1', category: 'Uang istri', estimatedAmount: 1200000, amountText: 'Rp1.200.000 (Lunas Sep ✓)', status: 'Wajib', isFixed: true, notes: 'Nafkah rutin bulanan September 2026 LUNAS terkirim', isPaid: true, paidDate: '31 Agu 2026' },
      { id: 'exp-2', category: 'Kewajiban rumah Mesir', estimatedAmount: 500000, amountText: 'Rp500.000 (Lunas Sep ✓)', status: 'Wajib', isFixed: true, notes: 'Kewajiban bulanan Mesir September 2026 LUNAS ✓', isPaid: true, paidDate: '31 Agu 2026' },
      { id: 'exp-3', category: 'Internet / kuota', estimatedAmount: 200000, amountText: 'Rp200.000', status: 'Wajib', isFixed: true, notes: 'Koneksi kerja & dev', isPaid: false },
      { id: 'exp-4', category: 'ChatGPT Plus', estimatedAmount: 360000, amountText: 'Rp360.000', status: 'Produktif / langganan aktif', isFixed: true, notes: 'AI Dev workflow', isPaid: false },
      { id: 'exp-5', category: 'Claude Pro (2 Akun)', estimatedAmount: 720000, amountText: '±Rp720.000 (2 Akun Aktif ✓)', status: 'Produktif / langganan aktif', isFixed: true, notes: 'Claude Pro (2 Akun Aktif) untuk AI Coding & High-Volume Reasoning', isPaid: true, paidDate: '1 Sep 2026' },
      { id: 'exp-6', category: 'Wavebox', estimatedAmount: 245000, amountText: '±Rp245.000', status: 'Produktif / langganan aktif', isFixed: true, notes: 'Multi-account workspace browser', isPaid: false },
      { id: 'exp-7', category: 'Kebutuhan makan / jajan rumah tangga', estimatedAmount: 'fleksibel', amountText: 'fleksibel (~Rp1.000.000 est.)', status: 'Wajib, fleksibel', isFixed: false, notes: 'Kebutuhan pokok pangan', isPaid: false },
      { id: 'exp-8', category: 'Kebutuhan anak', estimatedAmount: 'fleksibel', amountText: 'fleksibel', status: 'Wajib, fleksibel', isFixed: false, notes: 'Popok, susu & kebutuhan bayi', isPaid: false },
      { id: 'exp-9', category: 'Token / listrik', estimatedAmount: 'fleksibel', amountText: 'fleksibel', status: 'Wajib, fleksibel', isFixed: false, notes: 'Listrik kerja & rumah', isPaid: false },
      { id: 'exp-10', category: 'Transport / kebutuhan harian', estimatedAmount: 'fleksibel', amountText: 'fleksibel', status: 'Wajib, fleksibel', isFixed: false, notes: 'Bensin & mobilitas offline', isPaid: false },
      { id: 'exp-11', category: 'Imunisasi / kesehatan', estimatedAmount: 'tidak selalu bulanan', amountText: 'tidak selalu bulanan', status: 'Wajib, fleksibel', isFixed: false, notes: 'Medis darurat / jadwal vaksin', isPaid: false },
    ],
    transactions: [
      {
